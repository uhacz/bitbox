...
namespace bxGfx
{
    ...
    void submitRenderItem( bxGdiContext* ctx, bxGfx::InstanceData* instanceData, bxGdiBuffer cbuffer_instanceData, bxGfxRenderItem_Iterator itemIt, unsigned flags = bxGfx::eRENDER_ITEM_DEFAULT_MASK );
}///
