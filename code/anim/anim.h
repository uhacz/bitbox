...
void evaluateCommandList( bxAnim_Context* ctx, const bxAnim_Cmd* command_list,  const bxAnim_BlendBranch* blend_branches, unsigned int num_branches, const bxAnim_BlendLeaf* blend_leaves, unsigned int num_leaves, const bxAnim_Skel* skeleton );
