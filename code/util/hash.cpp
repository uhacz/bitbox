...
void murmur3_128x86_hash( void* out, const void* key, unsigned int len, unsigned int seed )
{
	const uint8_t * data = (const uint8_t*)key;
...
void murmur3_128x64_hash( void* out, const void* key, unsigned int len, unsigned int seed )
{
	const uint8_t * data = (const uint8_t*)key;
	const int nblocks = len / 16;
