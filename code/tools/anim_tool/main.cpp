...
int main( int argc, char** argv )
{
    ...
    const char* input_file =  "d:/dev/code/bitBox/assets/.src/anim/fast_run.bvh";// argv[1];
    const char* output_anim = "d:/dev/code/bitBox/assets/anim/fast_run.anim"; // ( argc > 2 ) ? argv[2] : 0;
