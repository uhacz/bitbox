...
namespace bxVoxel
{
    ...
    void gfx_sortListChunkFill_color( bxVoxel_GfxSortListColor* slist, bxChunk* slistChunk, const bxVoxel_GfxDisplayList* dlist, const bxChunk& dlistChunk, const bxVoxel_Container* container, const bxGfxCamera& camera )
    {
        ...
        for ( int iitem = dlistChunk.begin; iitem < dlistChunk.current; ++iitem )
        {
            ...
            bxGdi::sortList_chunkAdd( slist, slistChunk, slistItem );
        }
    }
 ...
 //       SYS_ASSERT( ichunk == nChunks );
    ...
    void gfx_displayListBuild( bxVoxel_Container* container, const bxGfxCamera& camera )
	{
        ...
        bxChunk_create( dlistChunks, nChunks, dlist->capacity );
        bxChunk_create( containerChunks, nChunks, container->_data.size );
        ...
        /// merge
        {
            ...
            finalChunk[0] = bxGdi::sortList_merge( slist, chunks, nChunks );
            bxGdi::sortList_sortLess( slist, finalChunk[0] );
        }
...
namespace
{
	...
	void _Gfx_startup( bxGdiDeviceBackend* dev, bxResourceManager* resourceManager, bxVoxel_Gfx* gfx )
	{
		...
		bxGdi::sortList_new( &gfx->_slist_color, MAX_DISPLAY_ITEMS, bxDefaultAllocator() );
		bxGdi::sortList_new( &gfx->_slist_depth, MAX_DISPLAY_ITEMS, bxDefaultAllocator() );
    ...
    void _Gfx_shutdown( bxGdiDeviceBackend* dev, bxResourceManager* resourceManager, bxVoxel_Gfx* gfx )
	{
		...
		bxGdi::sortList_delete( &gfx->_slist_color );
