...
Character1* character1_new()
{
    ...
    memset( &ch->shapeBody, 0x00, sizeof( Character1::Body ) );
...
void initShapeBody( Character1* ch, int shapeIterations, const Matrix4& worldPose )
{
    ...
    ParticleData& p = ch->particles;
    Character1::Body& body = ch->shapeBody;
...
{
    ParticleData* cp = &ch->particles;
    const Character1::Body& body = ch->shapeBody;
